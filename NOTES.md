...
- Pi 4 has two IP addresses (10.0.0.226 and 10.0.0.226) — likely ethernet + virtual interface; primary is 10.0.0.226
...
- Static IP not yet assigned — Pi is DHCP at 10.0.0.226; recommend router DHCP reservation to lock this in
